 ...
 * @prop {Handlebars=} handlebars - Instance of [Handlebars](http://handlebarsjs.com/) to use when rendering pages.
 ...
 * @prop {?(Function|String)} [template=null] - Path to a Handlebars template to use when rendering, or a pre-compiled template function.
